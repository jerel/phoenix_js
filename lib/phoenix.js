...
require.register("src/channel", function(exports, require, module) {
'use strict';
...
var Channel = (function () {
  function Channel(topic, params, socket) {
    ...
    this.joinPush = new _push2['default'](this, _constants.CHANNEL_EVENTS.join, this.params);
    this.pushBuffer = [];
    this.rejoinTimer = new _utilsTimer2['default'](function () {
      return _this.rejoinUntilConnected();
    }, this.socket.reconnectAfterMs);
    this.joinPush.receive("ok", function () {
      _this.state = _constants.CHANNEL_STATES.joined;
      _this.rejoinTimer.reset();
    });
    this.onClose(function () {
      _this.socket.log("channel", 'close ' + _this.topic);
      _this.state = _constants.CHANNEL_STATES.closed;
      _this.socket.remove(_this);
    });
    this.onError(function (reason) {
      _this.socket.log("channel", 'error ' + _this.topic, reason);
      _this.state = _constants.CHANNEL_STATES.errored;
      _this.rejoinTimer.setTimeout();
    });
    this.on(_constants.CHANNEL_EVENTS.reply, function (payload, ref) {
  ...
  _createClass(Channel, [{
    ...
    value: function onError(callback) {
      this.on(_constants.CHANNEL_EVENTS.error, function (reason) {
    ...
    value: function canPush() {
      return this.socket.isConnected() && this.state === _constants.CHANNEL_STATES.joined;
    }
  }, {
    key: 'push',
    value: function push(event, payload) {
      ...
      var pushEvent = new _push2['default'](this, event, payload);
      if (this.canPush()) {
        pushEvent.send();
      } else {
    ...
    value: function leave() {
      ...
      return this.push(_constants.CHANNEL_EVENTS.leave).receive("ok", function () {
        _this2.socket.log("channel", 'leave ' + _this2.topic);
        _this2.trigger(_constants.CHANNEL_EVENTS.close, "leave");
      });
    }
...
;require.register("src/constants", function(exports, require, module) {
"use strict";
...
;require.register("src/push", function(exports, require, module) {
"use strict";
...
;require.register("src/socket", function(exports, require, module) {
'use strict';
...
var Socket = (function () {
  ...
  function Socket(endPoint) {
    ...
    this.sendBuffer = [];
    this.ref = 0;
    this.transport = opts.transport || _transports.WebSocket || _transports.LongPoll;
    ...
    this.reconnectTimer = new _utilsTimer2['default'](function () {
  ...
  _createClass(Socket, [{
    ...
    value: function endPointURL() {
      var uri = _utilsAjax2['default'].appendParams(_utilsAjax2['default'].appendParams(this.endPoint, this.params), { vsn: _constants.VSN });
      if (uri.charAt(0) !== "/") {
        return uri;
      }
      if (uri.charAt(1) === "/") {
    ...
    value: function triggerChanError() {
      this.channels.forEach(function (channel) {
        return channel.trigger(_constants.CHANNEL_EVENTS.error);
      });
    }
  }, {
    key: 'connectionState',
    ...
    value: function channel(topic) {
      ...
      var channel = new _channel2['default'](topic, chanParams, this);
    ...
    value: function push(data) {
      ...
      var callback = function callback() {
        return _this4.conn.send(JSON.stringify(data));
      };
...
;require.register("src/transports", function(exports, require, module) {
'use strict';
...
var LongPoll = (function () {
  ...
  _createClass(LongPoll, [{
    ...
    value: function normalizeEndpoint(endPoint) {
      return endPoint.replace("ws://", "http://").replace("wss://", "https://").replace(new RegExp("(.*)\/" + _constants.TRANSPORTS.websocket), "$1/" + _constants.TRANSPORTS.longpoll);
    }
  }, {
    key: 'endpointURL',
    value: function endpointURL() {
      return _utilsAjax2['default'].appendParams(this.pollEndpoint, { token: this.token });
    }
  }, {
    key: 'closeAndRetry',
    ...
    value: function poll() {
      ...
      if (!(this.readyState === _constants.SOCKET_STATES.open || this.readyState === _constants.SOCKET_STATES.connecting)) {
        return;
      }

      _utilsAjax2['default'].request("GET", this.endpointURL(), "application/json", null, this.timeout, this.ontimeout.bind(this), function (resp) {
        if (resp) {
        ...
        switch (status) {
          ...
          case 204:
            ...
            break;
          case 410:
            _this.readyState = _constants.SOCKET_STATES.open;
            _this.onopen();
            _this.poll();
            break;
          case 0:
    ...
    value: function send(body) {
      ...
      _utilsAjax2['default'].request("POST", this.endpointURL(), "application/json", body, this.timeout, this.onerror.bind(this, "timeout"), function (resp) {
        if (!resp || resp.status !== 200) {
          _this2.onerror(status);
          _this2.closeAndRetry();
        }
      });
    }
  }, {
    ...
    value: function close(code, reason) {
      this.readyState = _constants.SOCKET_STATES.closed;
      this.onclose();
    }
  }]);
...
require.register("src/utils/ajax", function(exports, require, module) {
"use strict";
...
;require.register("src/utils/timer", function(exports, require, module) {
